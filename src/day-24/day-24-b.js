...
const code = []
code[4] = Math.max(1, 1 + values[3].y + values[4].x)
code[6] = Math.max(1, 1 + values[5].y + values[6].x)
code[8] = Math.max(1, 1 + values[7].y + values[8].x)
code[9] = Math.max(1, 1 + values[2].y + values[9].x)
code[10] = Math.max(1, 1 + values[1].y + values[10].x)
code[11] = Math.max(1, 1 + values[0].y + values[11].x)
code[13] = Math.max(1, 1 + values[12].y + values[13].x)
